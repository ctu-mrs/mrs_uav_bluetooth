...
WIFI_SERVICE_NAME = "mrs_uav_bluetooth/wifi"
WIFI_SSID_NAME = "mrs_uav_bluetooth/wifi/ssid"
WIFI_SSID_DESCRIPTOR_NAME = "mrs_uav_bluetooth/wifi/ssid/config"
WIFI_PASSWORD_DESCRIPTOR_NAME = "mrs_uav_bluetooth/wifi/password/config"
...
class WifiService(Service):
    def __init__(
        ...
        super().__init__(bus, index, WIFI_SERVICE_UUID, primary=True)
